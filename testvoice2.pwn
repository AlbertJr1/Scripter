...
public OnPlayerConnect(playerid)
{
    ...
    {
        new lstring[512];
        format(lstring, sizeof(lstring), ""WHITE"Dari: Penjaga kota Indoland\nKepada: Warga (pemain peran) di Kota Indoland, "RED"%s\n\n"WHITE"Untuk bermain peran di Indoland Roleplay, maka anda harus memenuhi syarat yaitu memasang Plugin Voice anda.", GetName(playerid));
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""JAVA"Indoland Roleplay "WHITE"- Plugin Tidak Terdeteksi", lstring, "Keluar", "");
    ...
    {
        new lstring[512];
        format(lstring, sizeof(lstring), ""WHITE"Dari: Penjaga kota Indoland\nKepada: Warga (pemain peran) di Kota Indoland, "RED"%s\n\n"WHITE"Untuk bermain peran di Indoland Roleplay, maka anda harus memenuhi syarat yaitu mengaktifkan Voice Sistem anda.", GetName(playerid));
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""JAVA"Indoland Roleplay "WHITE"- Mic Tidak Terdeteksi", lstring, "Keluar", "");
    ...
    else if((vdLocalStream[playerid] = SvCreateDLStreamAtPlayer(15.0, SV_INFINITY, playerid, 0xffff0000, "")))
    {
        ...
        SendClientMessage(playerid, -1, "[i] Selama di dalam server ingatlah aturan pokok Indoland Roleplay - > {FFFF00}Respect & Good Attitude.");
